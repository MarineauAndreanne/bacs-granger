...
const PLACEHOLDERS = {
  HEROS: [
    // primaryHero
    {
      heading: {value: 'Les Bacs Granger'},
      byline: {
        value:
          'Conception et réalisation artisanale de bacs à jardin surélevés.',
      },
      cta: {value: 'Voir nos produits →'},
      handle: 'freestyle',
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/gettyimages-629647243-1584436401.jpg?resize=980:*',
          },
